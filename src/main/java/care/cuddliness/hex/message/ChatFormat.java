...
public enum ChatFormat {
    PREFIX("PREFIX"), ARGUMENT("ARGUMENT"), DESCRIPTION("DESCRIPTION"), CODE("CODE"), ID("ID"), SPACER("SPACER"), BATTERY_1("BATTERY-1"), BATTERY_2("BATTERY-2"), BATTERY_3("BATTERY-3"), BATTERY_4("BATTERY-4"),
